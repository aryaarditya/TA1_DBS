...
base_colors = sns.color_palette("pastel", len(season_usage)) 
colors = [base_colors[i] if val < max_value else 'darkblue' for i, val in enumerate(season_usage['cnt'])]

fig, ax = plt.subplots(figsize=(10, 6))
sns.barplot(x='season', y='cnt', data=season_usage, palette=colors, ax=ax)
